...
public class AnalyseControler implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		if (arg0.getSource() == vue.fluideBox) {
			...
			//vue.model.setCanvas1(new CurveCanvasModel(vue.model.getCap1()));
			...
			vue.model.setDateList();
			//vue.model.setCanvas2(new CurveCanvasModel(vue.model.getCap2()));
			...
			vue.model.setDateList();
			//vue.model.setCanvas3(new CurveCanvasModel(vue.model.getCap3()));
